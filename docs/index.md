...
RecNextEval is an open-source Python toolkit that models temporal context to more
...
[recnexteval: a toolkit for offline evaluation of recommender systems](https://hdl.handle.net/10356/181114).

![recnexteval architecture](assets/_static/architecture.png)

The demo notebooks can be found in the `examples` directory: [examples on GitHub](https://github.com/HiIAmTzeKean/RecNextEval/tree/master/examples).

## Why Choose RecNextEval?
